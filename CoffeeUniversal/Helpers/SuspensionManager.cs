...
namespace CoffeeUniversal.Helpers
{
	...
	internal sealed class SuspensionManager
    {
        ...
        private static DependencyProperty FrameSessionBaseKeyProperty =
            DependencyProperty.RegisterAttached("FrameSessionBaseKeyParams", typeof(string), typeof(SuspensionManager), null);
        ...
        public static void RegisterFrame(Frame frame, string sessionStateKey, string sessionBaseKey = null)
        {
            ...
            {
                throw new InvalidOperationException(LocalizableStrings.APP_INVALID_FRAME_KEY);
            }

            if (frame.GetValue(FrameSessionStateProperty) != null)
            {
                throw new InvalidOperationException(LocalizableStrings.APP_INVALID_FRAME_REGISTRATION);
            }
    ...
    public class SuspensionManagerException : Exception
    {
        ...
        public SuspensionManagerException(Exception e)
            : base(LocalizableStrings.APP_SUSPENSION_MANAGER_FAIL, e)
        {
        }
    }
}
