...
namespace CoffeeUniversal.Helpers
{
    ...
    public sealed class ViewLifetimeController : INotifyPropertyChanged
    {
        ...
        private ViewLifetimeController(CoreWindow newWindow)
        {
        ...
        public static ViewLifetimeController CreateForCurrentView()
        {
            return new ViewLifetimeController(CoreWindow.GetForCurrentThread());
        }
