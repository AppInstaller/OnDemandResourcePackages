	...
	public class NavigationHelper : DependencyObject
	{
		...
		public void OnNavigatedTo(NavigationEventArgs e)
		{
			...
			else
			{
				...
				if (LoadState != null)
				{
					LoadState(this, new LoadStateEventArgs(e.Parameter, (Dictionary<string, object>)frameState[pageKey]));
				}
			}
		}
		...
		{
            Debug.WriteLine("NavigationHelper_OnNavigatedFrom");
            Dictionary<string,object> frameState = SuspensionManager.SessionStateForFrame(Frame);
            ...
            // HACK Race condition in non-debug mode that causes NavigationHelper_BackRequested to get called twice.
            // Must be done after handling state, otherwise state is not correctly saved/loaded.
		...
		{
			Debug.WriteLine("NavigationHelper_BackRequested");
